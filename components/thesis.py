...
def render_thesis(contract: dict):
    ...
    with col_bull:
        ...
        st.markdown(
            f'<div style="background:#e8f5ec;border-left:3px solid #2ecc71;padding:8px 12px;'
    ...
    with col_bear:
        ...
        st.markdown(
            f'<div style="background:#faeaea;border-left:3px solid #e74c3c;padding:8px 12px;'
    ...
    st.markdown(
        f'<div style="background:#eef3ff;border-left:3px solid #1e40af;padding:8px 12px;'
    ...
    if contract.get("watch_next_open"):
        ...
        st.markdown(
            f'<div style="background:#e8f0ff;border-left:3px solid #1e40af;padding:8px 12px;'
